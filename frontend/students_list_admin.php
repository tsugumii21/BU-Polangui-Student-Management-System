    ...
    <div class="container" style="padding-top: 2.5rem; padding-bottom: 3rem;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <?php
                    $addLink = "student_dashboard_admin.php";
        ...
        <div class="filter-bar-container">
            ...
            <form method="GET" action="students_list_admin.php" class="filter-form">
                ...
                <div class="filter-reset">
                    <a href="students_list_admin.php<?php echo $department_filter ? '?department='.urlencode($department_filter) : ''; ?>" class="btn-reset" title="Reset Filters"><i class="fas fa-redo"></i> Reset</a>
                </div>
